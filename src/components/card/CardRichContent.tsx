 ...
 * ConstellationPage.tsx (the editable section toggles and the edit footer
 * are intentionally omitted — every section renders, as it does for a
 * non-editing viewer). The manual-entry renderer is NOT touched; once this
 * is signed off on Insights, the constellation page can be switched to
 * render this component as the single source of truth.
 *
 * Pure presentational: all data comes in via props. The caller fetches (or
 * supplies) it and derives `count` / `firstSeenIso` / `lastSeenIso`.
 */
