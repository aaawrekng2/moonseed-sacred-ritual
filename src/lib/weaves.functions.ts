...
/**
 * Pure read-only twin of `detectWeavesForUser`. Returns the weaves that
 * WOULD be created on a real run, without performing any inserts. Useful
 * for an admin "preview" endpoint and for letting users sanity-check the
 * detector before running it.
 */
